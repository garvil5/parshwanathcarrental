	...
	<div class="inputform">
		<form action="searchByServlet" method="post">
			<table>
				<tr>
					<th>Vehicle Type:</th>
					<td><select id="vehicleSearch" name="vehicleSearch"
						onchange="EnableDisableTextBox(this)">
							...
							<option value="travelName">Travel Name</option>
							<option value="guestAddress">Guest Address</option>
	...
	<div class="inputform">
		...
		<table id="testTable" cellpadding="5"
			...
			<tr>
				...
				<td><a href="editResult.jsp?id=<%=resultSet.getString("sno")%> class="button"">Edit</a></td>
			</tr>
			<%
			}
			connection.close();
